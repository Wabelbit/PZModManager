...
class Ui_ModSelector(object):
    ...
    def retranslateUi(self, ModSelector):
        ...
        self.button_enable.setToolTip(QCoreApplication.translate("ModSelector", u"Enable the selected mods for the current configuration", None))
...
#if QT_CONFIG(tooltip)
        self.button_moveUp.setToolTip(QCoreApplication.translate("ModSelector", u"Move selected mods up to increase priority during game start", None))
#endif // QT_CONFIG(tooltip)
        self.button_moveUp.setText(QCoreApplication.translate("ModSelector", u"\u2191", None))
#if QT_CONFIG(tooltip)
        self.button_moveDown.setToolTip(QCoreApplication.translate("ModSelector", u"Move selected mods down to decrease priority during game start", None))
#endif // QT_CONFIG(tooltip)
        self.button_moveDown.setText(QCoreApplication.translate("ModSelector", u"\u2193", None))
#if QT_CONFIG(tooltip)
        self.button_disable.setToolTip(QCoreApplication.translate("ModSelector", u"Disable the selected mods for the current configuration", None))
#endif // QT_CONFIG(tooltip)
